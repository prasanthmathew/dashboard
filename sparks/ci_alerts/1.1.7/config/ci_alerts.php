...
$config['before_all'] = '';
$config['before_each'] = '';
$config['before_error'] = '<div class="alert alert-danger alert_pad"><a class="close" href="#" data-dismiss="alert">&times;</a>';
$config['before_success'] = '<div class="alert alert-success alert_pad"><a class="close" href="#" data-dismiss="alert">&times;</a>';
